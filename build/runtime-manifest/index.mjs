import { defineManifest as a } from "@rmc-toolkit/core";
import { createExternalMatcher as p, createImportMap as $ } from "@rmc-toolkit/core";
const s = "19.2.8", e = "https://esm.sh", r = "https://assets.ferry.rsvp", o = "https://ferry.rsvp", t = `${r}/web-pages`, m = a({
  namespace: "@ferryrsvp",
  ...
  exactImports: {
    ...
    "@ferryrsvp/liknoss-client": `${r}/liknoss-client/index.mjs`,
    "@ferryrsvp/web-runtime": `${r}/web-runtime/index.mjs`,
    "@ferryrsvp/web-ui": `${r}/web-ui/index.mjs`,
    "@ferryrsvp/web-auth": `${r}/web-auth/build/index.mjs`,
    "@ferryrsvp/language": `${o}/js/language.js`
  },
